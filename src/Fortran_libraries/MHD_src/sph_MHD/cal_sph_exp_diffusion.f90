...
!
     ...
     &           + fdm2_d2_mat( 0,k) * d_rj(inod,is_fld  )              &
     &           + fdm2_d2_mat( 1,k) * d_rj(i_p1,is_fld  )
        d2t_dr2 =  fdm2_d2_mat(-1,k) * d_rj(i_n1,is_fld+2)              &
     &           + fdm2_d2_mat( 0,k) * d_rj(inod,is_fld+2)              &
     &           + fdm2_d2_mat( 1,k) * d_rj(i_p1,is_fld+2)
!
