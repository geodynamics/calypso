...
!!      subroutine set_evolved_vector_bc_by_file(field_name, sph_rj,    &
!!     &          bc_IO, ref_grp, iflag_bc_vector, bc_Vevo)
!!
!!      subroutine set_fixed_scalar_bc_by_file(field_name, sph_rj,      &
!!     &          bc_IO, ref_grp, iflag_bc_scalar, bc_Sspec)
!!      subroutine set_evolved_scalar_bc_by_file(field_name, sph_rj,    &
!!     &          bc_IO, ref_grp, iflag_bc_scalar, bc_Sevo)
!!
!!      subroutine set_fixed_grad_bc_by_file(field_name, sph_rj,        &
!!     &          bc_IO, ref_grp, iflag_bc_scalar, bc_Sspec)
!!      subroutine set_evolved_grad_bc_by_file(field_name, sph_rj,      &
!!     &          bc_IO, ref_grp, iflag_bc_scalar, bc_Sevo)
