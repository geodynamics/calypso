...
\subsubsection{Field data for visualization}
\label{sec:VTK}
...
\subsection{Section and isosurface data converter program ({\tt psf\_to\_VTK})} 
...
\subsubsection{Averaging for mean square and power spectrum \\
...
This program generate time average and standard deviation of each spherical harmonic coefficients data file \verb|[picked_sph_prefix]_l[degree]_m[ordedr][c/s].dat|.

In this program, file name excluding the extension \verb|[.dat]| \\
(\verb|[picked_sph_prefix]_l[degree]_m[ordedr][c/s]|), start time, and end time are required in the interactive input. If data is end before the end time, the program will finish at the end of file. \verb|t_ave| and \verb|t_sigma| are added at the beginning of the input file name for the time average and standard deviation data file, respectively.
%
