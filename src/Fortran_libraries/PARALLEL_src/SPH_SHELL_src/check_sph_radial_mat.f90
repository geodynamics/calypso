...
!!@endverbatim
!!
!!@n @param id_rank   radius to three next points of ICB
...
!
!
      write(50+id_rank,'(a)') 'k, r, a(k,k-1), a(k,k), a(k,k+1)'
      write(50+id_rank,'(i6,1p4E25.15e3)')  izero, zero,                &
     &              -1.0d30, mat00(2,0), mat00(1,1)
      do k = 1, nri-1
        write(50+id_rank,'(i6,1p4E25.15e3)') k, rr(k),                  &
     &              mat00(3,k-1), mat00(2,k), mat00(1,k+1)
      end do
      write(50+id_rank,'(i6,1p4E25.15e3)') nri, rr(nri),                &
...
!
      do j = 1, jmax
        write(50+id_rank,'(a,4i6)') '(j, global_j, l, m): ',            &
     &                            j, j_sph(jmax,1:3)
        call check_single_radial_3band_mat                              &
     &     (id_rank, nri, rr, mat(1,1,j))
      end do
!
...
!
     ...
     &          'k, r, a(k,k-1), a(k,k), a(k,k+1)'
      write(50+id_rank,'(i6,1p4E25.15e3)') ione, rr(1),                 &
...
!
     ...
     &          'k, r, a(k,k-2), a(k,k-1), a(k,k), a(k,k+1), a(k,k+2)'
      write(50+id_rank,'(i6,1p6E25.15e3)') ione, rr(1),                 &
     &              -1.0d30, -1.0d30, (mat(3-l,1+l),l=0,2)
      write(50+id_rank,'(i6,1p6E25.15e3)') itwo, rr(2),                 &
     &              -1.0d30, (mat(3-l,2+l),l=-1,2)
      do k = 3, nri-2
        write(50+id_rank,'(i6,1p6E25.15e3)') k, rr(k),                  &
     &             (mat(3-l,k+l),l=-2,2)
      end do
      write(50+id_rank,'(i6,1p6E25.15e3)') (nri-1), rr(nri-1),          &
     &              (mat(3-l,nri-1+l),l=-2,1), 1.0d30
      write(50+id_rank,'(i6,1p6E25.15e3)') nri, rr(nri),                &
