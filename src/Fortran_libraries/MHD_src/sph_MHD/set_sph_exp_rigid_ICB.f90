...
!!      subroutine cal_sph_nod_icb_rgd_w_diffuse2(jmax, g_sph_rj,       &
!!     &          kr_in, r_ICB, fdm2_fix_fld_ICB, coef_d,               &
!!     &          is_fld, is_diffuse, n_point, ntot_phys_rj, d_rj)
!!@endverbatim
!!
