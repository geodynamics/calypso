...
!
      ...
      call alloc_group_num(theta_rtp_grp)
!
      call set_stack_rtp_meridional_grp                                 &
     &   (sph_rtp, med_layer_grp, theta_rtp_grp)
!
      call alloc_group_item(theta_rtp_grp)
...
!
     ...
     &    sph_param, added_radial_grp, sph_rj%nidx_global_rj(1))
      call alloc_group_num(radial_rj_grp)
      call set_stack_rj_radial_grp                                      &
     &   (sph_param, sph_rj, added_radial_grp, radial_rj_grp)
!
      call alloc_group_item(radial_rj_grp)
...
!
      ...
      call alloc_group_num(bc_rtp_grp)
      call alloc_group_item(bc_rtp_grp)
!
...
!
      ...
      call alloc_group_num(zonal_rtp_grp)
      call alloc_group_item(zonal_rtp_grp)
!
