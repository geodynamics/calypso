...
!
!      subroutine copy_node_import_type_from_IO(comm_tbls)
!      subroutine copy_node_import_type_to_IO(my_rank, comm_tbls)
...
!
      call allocate_type_comm_tbl_num(comm_tbls)
!
      call copy_num_import(comm_tbls%num_neib, comm_tbls%id_neib,       &
     &    comm_tbls%istack_import, comm_tbls%istack_export,             &
     &    comm_tbls%ntot_import, comm_tbls%ntot_export,                 &
...
!
      call allocate_type_comm_tbl_item(comm_tbls)
!
      call copy_communication_item(comm_tbls%ntot_import,               &
     &    comm_tbls%ntot_export, comm_tbls%item_import,                 &
     &    comm_tbls%item_export, item_import_IO, item_export_IO)
!
      call deallocate_comm_item_IO
!
      end subroutine copy_node_import_type_from_IO
!
!-----------------------------------------------------------------------
!
      subroutine copy_node_import_type_to_IO(my_rank, comm_tbls)
...
!
     ...
     &    ntot_export_IO, comm_tbls%id_neib, comm_tbls%istack_import)
!
      call allocate_comm_item_IO
!
      call copy_communication_item(ntot_import_IO, ntot_export_IO,      &
     &    item_import_IO, item_export_IO, comm_tbls%item_import,        &
     &    comm_tbls%item_export)
!
      end subroutine copy_node_import_type_to_IO
!
!-----------------------------------------------------------------------
!
