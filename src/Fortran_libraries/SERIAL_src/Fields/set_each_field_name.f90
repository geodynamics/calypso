...
!
      ...
      use set_MHD_filter_fld_address
...
!
     ...
     &   .or. check_filter_vector_fields(phys_name_ctl)
      if(flag) then
...
!
     ...
     &   .or. check_filter_scalar_fields(phys_name_ctl)
      if(flag) then
...
!
     ...
     &   .or. check_filter_sym_tensor_fields(phys_name_ctl)
      if(flag) then
