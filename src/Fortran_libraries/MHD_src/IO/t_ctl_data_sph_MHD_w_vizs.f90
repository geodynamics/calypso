...
!!     &                                          add_VMHD_ctl)
!!      subroutine write_sph_mhd_ctl_w_vizs(id_control, hd_block,       &
...
!
      private :: read_sph_mhd_ctl_w_vizs, write_sph_mhd_ctl_w_vizs
!
! ----------------------------------------------------------------------
!
      contains
...
!
      ...
      level1 = 0
      call write_sph_mhd_ctl_w_vizs(id_control_file, hd_mhd_ctl,        &
