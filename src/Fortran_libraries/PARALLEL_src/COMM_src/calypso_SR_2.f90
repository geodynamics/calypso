...
!!
!!@verbatim
!!      subroutine calypso_send_recv_2(iflag_recv, nnod_org, nnod_new,  &
...
!!      subroutine calypso_send_recv_3x2(iflag_recv, nnod_org, nnod_new,&
!!     &          npe_send, id_pe_send, istack_send, inod_export,       &
!!     &          npe_recv, id_pe_recv, istack_recv, inod_import,       &
...
!C-- COMM
     ...
     &   (itwo, npe_send, id_pe_send, istack_send, SR_r%WS(1),          &
     &          npe_recv, id_pe_recv, istack_recv, iflag_self,          &
     &          SR_r%WR(1), SR_sig)
!
!C-- RECV
      call sel_copy_from_recv_buf_2(iflag_recv, nnod_new,               &
...
!
!
      call resize_work_SR((itwo*ithree), npe_send, npe_recv,            &
     &    istack_send(npe_send), istack_recv(npe_recv), SR_sig, SR_r)
!
!C-- SEND
...
!
!C-- RECV
      call sel_copy_from_recv_buf_3x2(iflag_recv, nnod_new,             &
     &    istack_recv(npe_recv), inod_import, irev_import,              &
