...
!!      subroutine read_import_data(id_file, comm_IO, ierr)
!!      subroutine read_export_data(id_file, comm_IO, ierr)
...
!
!
      call skip_comment(id_file, character_4_read, ierr)
      if(ierr .gt. 0) return
