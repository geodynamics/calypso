!>@file   sph_FDM4_pol_hdiv_viscosity.f90
!!@brief  module sph_FDM4_pol_hdiv_viscosity
!!
!!@author H. Matsui
...
!!        type(fdm_matrices), intent(in) :: fdm_4
...
!!     &          flag_viscous_variation, flag_ref_density_valiation,   &
!!     &          coef_p, coef_d, relative_d, h_nu, h_rho, h_drhodr,    &
!!     &          fdm_4, fdm_3e, fdm_e3, mat4_viscous, hdiv_visous_mat, &
!!     &          mat9)
!!        type(sph_rj_grid), intent(in) :: sph_rj
!!        logical, intent(in) :: flag_viscous_variation
!!        logical, intent(in) :: flag_ref_density_valiation
...
!!@endverbatim
!!
      module sph_FDM4_pol_hdiv_viscosity
!
      use m_precision
      use m_constants
!
...
!$omp parallel do private(kr,mat3_grad_p,mat4_viscous)
     ...
     &     (fdm_4%n_minus, fdm_4%n_plus, sph_rj%nidx_rj(2),             &
     &      flag_viscous_variation, flag_ref_density_valiation,         &
...
! -----------------------------------------------------------------------
!
      end module sph_FDM4_pol_hdiv_viscosity
