...
\verb|VTK| & VTK & \verb|.vtk| & ParaView \\ \hline
\verb|VTK_gzip| & Compressed VTK & \verb|.vtk.gz| & ParaView \\
& & & after expanding by {\tt gzip}  \\ \hline
\verb|PSF| & Binary & \verb|0.sgd| (grid data)& - \\
           &        &  \verb|.sdt| (field data) & - \\ \hline
\verb|PSF_gzip| & Compressed binary & \verb|.sgd.gz| (grid data) & - \\
           &        &  \verb|.sdt.gz| (field data) & - \\ \hline
\end{tabular}
\end{center} 
\end{table} 
...
\verb|VTK_gzip| & Compressed VTK & \verb|.vtk.gz| & ParaView \\
& & & after expanding by {\tt gzip}  \\ \hline
\verb|ISO| & Binary & \verb|.sfm| & - \\ \hline
\verb|ISO_gzip| & Compressed binary & \verb|.sfm.gz| & - \\ \hline
\end{tabular}
\end{center} 
\end{table} 
