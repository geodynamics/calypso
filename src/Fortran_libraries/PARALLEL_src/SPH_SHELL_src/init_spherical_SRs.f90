...
!
      call check_calypso_sph_buffer_N(NB, comms_sph, SR_sig, SR_r)
...
!
     ...
     &          X_rtp, X_rtm, X_rlm, X_rj, iflag_recv, SR_sig, SR_r)
!
      use calypso_mpi
...
!
     ...
     &    nnod_rtp, nnod_rtm, nnod_rlm, nnod_rj,                        &
     &    X_rtp, X_rtm, X_rlm, X_rj, SR_sig, SR_r)
!
...
!
     ...
     &   (NB, comms_sph%comm_rj, comms_sph%comm_rlm, SR_sig, SR_r)
      call finish_send_recv_sph(comms_sph%comm_rj, SR_sig)
      call calypso_sph_comm_N                                           &
     &   (NB, comms_sph%comm_rlm, comms_sph%comm_rj, SR_sig, SR_r)
      call finish_send_recv_sph(comms_sph%comm_rlm, SR_sig)
      call calypso_sph_comm_N                                           &
     &   (NB, comms_sph%comm_rtp, comms_sph%comm_rtm, SR_sig, SR_r)
      call finish_send_recv_sph(comms_sph%comm_rtp, SR_sig)
      call calypso_sph_comm_N                                           &
     &   (NB, comms_sph%comm_rtm, comms_sph%comm_rtp, SR_sig, SR_r)
