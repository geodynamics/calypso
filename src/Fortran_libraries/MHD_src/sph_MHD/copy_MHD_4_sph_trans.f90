...
!!      subroutine copy_mhd_sph_spec_to_trans
!!      subroutine copy_mhd_sph_fld_from_trans
!!
!!  routines for forward transform
!!      subroutine copy_mhd_sph_fld_to_trans
!!      subroutine copy_mhd_sph_spec_from_trans
!!@endverbatim
!
...
!$omp end parallel
!
      end subroutine copy_mhd_sph_spec_to_trans
!
!-----------------------------------------------------------------------
!
      subroutine copy_mhd_sph_fld_from_trans
...
!$omp end parallel
!
      end subroutine copy_mhd_sph_fld_from_trans
!
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
!
...
!$omp end parallel
!
      end  subroutine copy_mhd_sph_fld_to_trans
!
!-----------------------------------------------------------------------
!
      subroutine copy_mhd_sph_spec_from_trans
...
!
!   divergence of Coriolils force flag
      call copy_scalar_spec_from_trans(ncomp_rtp_2_rj,                  &
     &      ipol%i_div_Coriolis, f_trns%i_div_Coriolis)
!$omp end parallel
!
      end  subroutine copy_mhd_sph_spec_from_trans
!
!-----------------------------------------------------------------------
!
