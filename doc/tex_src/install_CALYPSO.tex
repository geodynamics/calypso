...
\subsubsection{Clean}
The object and fortran module files in {\tt work} directory is deleted by using
\begin{verbatim}
% make clean
\end{verbatim}
This command deletes files with the extension {\tt .o}, {\tt .mod}, {\tt .par}, {\tt .diag}, and backup files with " \~\ " at the end of file name. Executable files in the {\tt bin} directory are not deleted.
