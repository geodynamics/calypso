...
!!
!!@verbatim
!!      subroutine cal_dsdr_sph_fix_scalar_in_2(idx_rj_degree_zero,     &
...
!!
!!      subroutine cal_dsdr_sph_fix_scalar_out_2(jmax, kr_out, r_CMB,   &
...
! -----------------------------------------------------------------------
!
      subroutine cal_dsdr_sph_fix_scalar_out_2(idx_rj_degree_zero,      &
