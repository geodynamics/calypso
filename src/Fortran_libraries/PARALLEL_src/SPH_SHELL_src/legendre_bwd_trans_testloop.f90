...
!          st_elapsed = MPI_WTIME()
     ...
     &        WK_l_tst%pol_e(1,ip), WK_l_tst%tor_e(1,ip),               &
     &        WK_l_tst%pol_o(1,ip), WK_l_tst%tor_o(1,ip) )
...
!
     ...
     &          kst, nkr, jst, n_jk_e, n_jk_o, ncomp, nvector, nscalar, &
...
!
     ...
     &          kst, nkr, mp_rlm, nl_rtm, symp, asmp,                   &
