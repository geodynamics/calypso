!>@file   calypso_SR_rev_6.f90
!!@brief  module calypso_SR_rev_6
!!
!!@author H. Matsui
...
!!
!!@verbatim
!!      subroutine calypso_send_recv_rev_6(nnod_org, nnod_new,          &
!!     &                           npe_send, isend_self,                &
!!     &                           id_pe_send, istack_send, inod_export,&
!!     &                           npe_recv, irecv_self,                &
!!     &                           id_pe_recv, istack_recv, irev_import,&
!!     &                           X_org, X_new)
!!      subroutine calypso_send_recv_rev_3x6(nnod_org, nnod_new,        &
!!     &                           npe_send, isend_self,                &
!!     &                           id_pe_send, istack_send, inod_export,&
!!     &                           npe_recv, irecv_self,                &
!!     &                           id_pe_recv, istack_recv, irev_import,&
