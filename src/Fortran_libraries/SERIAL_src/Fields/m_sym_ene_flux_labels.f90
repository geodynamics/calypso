...
!!         @f$ u_{symi} (e_{ijk} \tilde{J}_{symj} \tilde{B}_{asymk}) @f$
     ...
     &                name = 'us_d_js_x_ba',                            &
     &                math                                              &
     &    = '$ u_{symi} (e_{ijk} \tilde{J}_{symj} \tilde{B}_{asymk})$')
!>        Field label of work of Lorentz force
!!         @f$ u_{symi} (e_{ijk} \tilde{J}_{asymj} \tilde{B}_{symk}) @f$
     ...
     &                name = 'us_d_ja_x_bs',                            &
     &                math                                              &
     &    = '$ u_{symi} (e_{ijk} \tilde{J}_{asymj} \tilde{B}_{symk})$')
!>        Field label of work of Lorentz force
!!         @f$ u_{asymi} (e_{ijk} \tilde{J}_{symj} \tilde{B}_{symk}) @f$
     ...
     &                name = 'ua_d_js_x_bs',                            &
     &                math                                              &
     &    = '$ u_{asymi} (e_{ijk} \tilde{J}_{symj} \tilde{B}_{symk})$')
!>        Field label of work of Lorentz force
!!         @f$ u_{asymi} (e_{ijk} \tilde{J}_{asymj} \tilde{B}_{asymk}) @f$
     ...
     &                name = 'ua_d_ja_x_ba',                            &
     &                math                                              &
     &  = '$ u_{asymi} (e_{ijk} \tilde{J}_{asymj} \tilde{B}_{asymk})$')
! 
...
!!         @f$ -u_{symi} \alpha_{T} g_{i} \tilde{T}_{sym} @f$
     ...
     &                math                                              &
     &   = '$ u_{asymi} (e_{ijk} \tilde{J}_{asymj} \tilde{B}_{symk})$')
