...
!!
!!@verbatim
!!      subroutine allocate_psf_case_table
!!      subroutine alloc_psf_case_tbl_item(i)
!!      subroutine deallocate_psf_case_table
...
!>      Structure for triangle patch list (instance)
      type(psf_cases), allocatable, save :: psf_case_tbl(:)
!
!
!  ---------------------------------------------------------------------
!
...
!
      subroutine allocate_psf_case_table
!
      allocate(psf_case_tbl(0:255))
!
      end subroutine allocate_psf_case_table
!
!  ---------------------------------------------------------------------
!
      subroutine alloc_psf_case_tbl_item(i)
...
!
      allocate(psf_case_tbl(i)%iedge(psf_case_tbl(i)%npatch,3))
      if(psf_case_tbl(i)%npatch .gt.0) psf_case_tbl(i)%iedge = 0
!
...
!
      do i = 0, 255
        deallocate(psf_case_tbl(i)%iedge)
      end do
      deallocate(psf_case_tbl)
!
      end subroutine deallocate_psf_case_table
!
!  ---------------------------------------------------------------------
!
