...
!!
!!@verbatim
!!      subroutine write_step_field_file_mpi(file_name, t_IO, fld_IO)
...
!
     ...
     &    ioff_gl, num64, fld_IO%num_field_IO, fld_IO%istack_numnod_IO)
      fld_IO%nnod_IO = int(num64)
!
