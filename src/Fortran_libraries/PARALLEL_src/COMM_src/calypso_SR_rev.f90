!>@file   calypso_SR_rev.f90
!!@brief  module calypso_SR_rev
!!
!!@author H. Matsui
...
!!
!!@verbatim
!!      subroutine calypso_send_recv_rev(nnod_org, nnod_new,            &
!!     &                           npe_send, isend_self,                &
!!     &                           id_pe_send, istack_send, inod_export,&
!!     &                           npe_recv, irecv_self,                &
!!     &                           id_pe_recv, istack_recv, irev_import,&
!!     &                           X_org, X_new)
!!      subroutine calypso_send_recv_rev_3x1(nnod_org, nnod_new,        &
!!     &                           npe_send, isend_self,                &
!!     &                           id_pe_send, istack_send, inod_export,&
!!     &                           npe_recv, irecv_self,                &
!!     &                           id_pe_recv, istack_recv, irev_import,&
...
!C-- SEND
!
      call set_to_send_buf_1(nnod_org,                                  &
...
!
      end subroutine calypso_send_recv_rev
!
! ----------------------------------------------------------------------
!
      subroutine calypso_send_recv_rev_3x1(nnod_org, nnod_new,          &
...
!C-- SEND
!
      call set_to_send_buf_3x1(nnod_org, istack_send(npe_send),         &
...
!
      end subroutine calypso_send_recv_rev_3x1
!
! ----------------------------------------------------------------------
!
      end module calypso_SR_rev
