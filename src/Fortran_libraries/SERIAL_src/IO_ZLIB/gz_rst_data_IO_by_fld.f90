...
!
      call open_rd_gzfile_a(gzip_name, zbuf_r)
!
...
!
      call skip_gz_comment_int(fld_IO%num_field_IO, zbuf_r)
...
!
      ...
      call read_gz_rst_field_comps(fld_IO, zbuf_r)
!
      call close_gzfile_a(zbuf_r)
!
...
!
      do i = 1, fld_IO%num_field_IO
        call skip_gz_comment_chara(fld_IO%fld_name(i), zbuf)
