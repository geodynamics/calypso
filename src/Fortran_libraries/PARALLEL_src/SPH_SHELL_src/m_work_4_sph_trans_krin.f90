...
!!
!!      subroutine clear_b_trans_vector_krin(nfld)
!!      subroutine clear_b_trans_scalar_krin(nfld)
!!
!!      subroutine clear_f_trans_vector_krin(nfld)
!!      subroutine clear_f_trans_scalar_krin(nfld)
!!
...
!!@n       size: vr_rtm_krin(nfld*nidx_rtm(1),nidx_rtm(2),nidx_rtm(3),3)
...
!!@n      size: sp_rlm_krin(nfld*nidx_rtm(1),nidx_rlm(2),3)
