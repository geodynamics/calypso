...
!!
!!@verbatim
!!      subroutine single_interpolate_scalar_ele27(numnod, numele, ie,  &
...
!
          ...
          i21 = ie(iele_gauss,21)
          i22 = ie(iele_gauss,22)
          i23 = ie(iele_gauss,23)
          i24 = ie(iele_gauss,24)
          i25 = ie(iele_gauss,25)
          i26 = ie(iele_gauss,26)
          i27 = ie(iele_gauss,27)
!
          xi = xi_gauss(1)
          ei = xi_gauss(2)
          zi = xi_gauss(3)
...
!
     ...
     &                + an27 * v_org(i27)
!
      end subroutine single_interpolate_scalar_ele27
!
! ----------------------------------------------------------------------
!
      subroutine s_interpolate_scalar_ele27(np_smp, numnod, numele, ie, &
