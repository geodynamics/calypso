...
\hline
\multicolumn{5}{|c|}{Distributed files} \\ \hline
\verb|[field_file_fmt_ctl]| &  \verb|ascii| & \verb|binary| & \verb|gzip| & \verb|bin_gz| \\ \hline
...
\begin{tabular}{|c|c|c|c|c|}
\hline
File format & \verb|[field_file_fmt_ctl]|  & \verb|extension| & size (MByte) & time (sec)  \\ \hline \hline
             &  \verb|ascii| & \verb|[#].fld|  & \verb|gzip| & \verb|bin_gz| \\
Parallel &  \verb|binary| & \verb|[#].flb|  & \verb|gzip| & \verb|bin_gz| \\
            &  \verb|gzip| &  \verb|[#].fld.gz| & \verb|gzip| & \verb|bin_gz| \\
            &  \verb|bin_gz| &\verb|[#].flb.gz| & \verb|gzip| & \verb|bin_gz| \\ \hline
              & \verb|merged|  &  \verb|[#].fld| & \verb|gzip| & \verb|bin_gz| \\
 Merged &  \verb|merged_bin| &  \verb|.flb| & \verb|gzip| & \verb|bin_gz| \\
              &  \verb|merged_gz| &  \verb|.fld.gz| & \verb|gzip| & \verb|bin_gz| \\
              &  \verb|merged_bin_gz| &  \verb|.flb.gz| & \verb|gzip| & \verb|bin_gz| \\ \hline
\end{tabular}
\end{center}
\label{table:field_format2}
\end{table}
%
...
Compressed binary & \verb|PSF_gzip| & \verb|.sgd.gz| (grid) & 1.17 & \\
