!>@file   sph_exp_nod_psd_vacuum_CMB.f90
!!@brief  module sph_exp_nod_psd_vacuum_CMB
!!
!!@author H. Matsui
...
!!      subroutine cal_sph_nod_cmb_qvc_mag2(jmax, kr_out,               &
!!     &                                    n_point, d_rj_fld)
!!        integer(kind = kint), intent(in) :: jmax, kr_out
!!        integer(kind = kint), intent(in) :: n_point
!!        real(kind = kreal), intent(inout) :: d_rj_fld(n_point,3)
!!
!!      subroutine cal_sph_nod_cmb_qvc_vp_rot2(jmax, kr_out, n_point,   &
!!     &                                       d_rj_fld, d_rj_rot)
!!        integer(kind = kint), intent(in) :: jmax, kr_out
!!        integer(kind = kint), intent(in) :: n_point
...
!
      module sph_exp_nod_psd_vacuum_CMB
!
      use m_precision
      use m_constants
!
...
! -----------------------------------------------------------------------
!
      end module sph_exp_nod_psd_vacuum_CMB
