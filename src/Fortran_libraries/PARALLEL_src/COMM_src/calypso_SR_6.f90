...
!!
!!@verbatim
!!      subroutine calypso_send_recv_6(iflag_recv, nnod_org, nnod_new,  &
...
!!      subroutine calypso_send_recv_3x6(iflag_recv, nnod_org, nnod_new,&
!!     &          npe_send, id_pe_send, istack_send, inod_export,       &
!!     &          npe_recv, id_pe_recv, istack_recv, inod_import,       &
...
!
!
      call resize_work_SR(isix, npe_send, npe_recv,                     &
...
!
!C-- RECV
      call sel_copy_from_recv_buf_6(iflag_recv, nnod_new,               &
...
!
!C-- RECV
      call sel_copy_from_recv_buf_3x6(iflag_recv, nnod_new,             &
     &    istack_recv(npe_recv), inod_import, irev_import,              &
