!>@file  MPI_surface_data_IO_b.f90
!!       module MPI_surface_data_IO_b
!!
!!@author H. Matsui
...
!!
!!@verbatim
!!      subroutine mpi_read_surface_connection_b                        &
!!     &         (IO_param, comm_IO, ele_IO, sfed_IO)
!!        type(communication_table), intent(inout) :: comm_IO
!!        type(node_data), intent(inout) :: nod_IO
!!        type(element_data), intent(inout) :: ele_IO
!!        type(surf_edge_IO_data), intent(inout) :: sfed_IO
!!      subroutine mpi_write_surface_connection_b                       &
!!     &         (IO_param, comm_IO, ele_IO, sfed_IO)
!!        type(communication_table), intent(inout) :: comm_IO
...
!!
!!      subroutine mpi_read_surface_geometry_b                          &
!!     &         (IO_param, nod_IO, sfed_IO)
!!        type(communication_table), intent(inout) :: comm_IO
!!        type(node_data), intent(inout) :: nod_IO
!!        type(surf_edge_IO_data), intent(inout) :: sfed_IO
!!      subroutine mpi_write_surface_geometry_b                         &
!!     &         (IO_param, nod_IO, sfed_IO)
!!        type(communication_table), intent(inout) :: comm_IO
!!        type(node_data), intent(in) :: nod_IO
!!        type(surf_edge_IO_data), intent(in) :: sfed_IO
...
!
      end subroutine mpi_read_surface_connection_b
!
!------------------------------------------------------------------
!------------------------------------------------------------------
!
...
!
      end subroutine mpi_write_surface_connection_b
!
!------------------------------------------------------------------
!------------------------------------------------------------------
!
...
!
      end subroutine mpi_read_surface_geometry_b
!
!------------------------------------------------------------------
!------------------------------------------------------------------
!
...
!
      end subroutine mpi_write_surface_geometry_b
!
!------------------------------------------------------------------
!
      end module MPI_surface_data_IO_b
