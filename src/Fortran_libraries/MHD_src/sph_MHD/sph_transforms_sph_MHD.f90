!>@file   sph_transforms_sph_MHD.f90
!!@brief  module sph_transforms_sph_MHD
!!
!!@author H. Matsui
!!@date Programmed in Aug., 2007
!!@n    Modified in Apr. 2013
!
!>@brief Spherical harmonics transform for MHD dynamo model
!!       including Coriolis terms
!!
!!@verbatim
!!      subroutine sph_b_trans_sph_MHD(nvector, nscalar, ntensor)
!!      subroutine sph_f_trans_sph_MHD(nvector, nscalar, ntensor)
!!
...
!
      ...
      call sum_rot_coriolis_rlm_10(ncomp)
      call sum_div_coriolis_rlm_10(ncomp)
...
!
      end subroutine sph_b_trans_sph_MHD
!
! -----------------------------------------------------------------------
!
      subroutine sph_f_trans_sph_MHD(nvector, nscalar, ntensor)
...
!
      call start_eleps_time(13)
      call copy_rot_coriolis_rlm
      call copy_div_coriolis_rlm
      call end_eleps_time(13)
!
      START_SRtime= MPI_WTIME()
...
!      call check_sp_rj(my_rank, ncomp)
!
      end subroutine sph_f_trans_sph_MHD
!
! -----------------------------------------------------------------------
!
      end module sph_transforms_sph_MHD
