...
!!
!!@verbatim
!!      subroutine calypso_send_recv_2(nnod_org, nnod_new,    &
!!     &                         npe_send, isend_self,                  &
...
!!     &                         X_org, X_new)
!!      subroutine calypso_send_recv_3x2(nnod_org, nnod_new,  &
!!     &                         npe_send, isend_self,                  &
!!     &                         id_pe_send, istack_send, inod_export,  &
!!     &                         npe_recv, irecv_self,                  &
!!     &                         id_pe_recv, istack_recv, inod_import,  &
...
!
!C-- RECV
      call sel_cppy_from_recv_buf_2(SR_sig%iflag_recv, nnod_new,        &
...
!
!C-- RECV
      call sel_cppy_from_recv_buf_3x2(SR_sig%iflag_recv, nnod_new,      &
     &    istack_recv(npe_recv), inod_import, irev_import,              &
