!>@file   spherical_SR_rev.f90
!!@brief  module spherical_SR_rev
!!
!!@author H. Matsui
...
!!
!!@verbatim
!!      subroutine sph_send_recv_by_rev(nnod_org, nnod_new,             &
