...
!
!      subroutine s_cal_jacobian_2d_8(numnod, numsurf,                  &
...
!
      ...
      integer(kind = kint), intent(in) :: ie_surf(numsurf, num_quad_sf)
...
!$omp&  (ist,ied,isurf,i1,i2,i3,i4,i5,i6,i7,i8,                         &
...
!$omp end parallel do
!
      end subroutine s_cal_jacobian_2d_8
!
!-----------------------------------------------------------------------
!
      end module cal_jacobian_2d_quad
