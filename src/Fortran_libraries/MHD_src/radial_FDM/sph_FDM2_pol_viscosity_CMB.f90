!>@file   sph_FDM2_pol_viscosity_CMB.f90
!!@brief  module sph_FDM2_pol_viscosity_CMB
!!
!!@author H. Matsui
...
!!     &         fdm_e1, fdm2_fix_dr_CMB, fdm2_free_CMB,                &
...
!!@endverbatim
!!
      module sph_FDM2_pol_viscosity_CMB
!
      use m_precision
      use m_constants
!
...
!
     ...
     &      g_sph_rj, coef_d, relative_d(kr+1), h_nu(kr+1),             &
     &      h_rho(kr+1), h_drhodr(kr+1),                                &
     &      fdm2_fix_dr_CMB(-1,2), fdm2_fix_dr_CMB(-1,3),               &
     &      mat2_viscous_CMB)
      end if
...
!  -------------------------------------------------------------------
!
      end module sph_FDM2_pol_viscosity_CMB
