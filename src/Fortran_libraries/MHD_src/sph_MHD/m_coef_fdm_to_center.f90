...
!!      dfdr =      coef_fdm_fix_2ctr_2(-1,2) * d_rj(0)
!!                + coef_fdm_fix_2ctr_2( 0,2) * d_rj(1)
!!                + coef_fdm_fix_2ctr_2( 1,2) * d_rj(2)
!!      d2fdr2 =    coef_fdm_fix_2ctr_2(-1,3) * d_rj(0)
!!                + coef_fdm_fix_2ctr_2( 0,3) * d_rj(1)
!!                + coef_fdm_fix_2ctr_2( 1,3) * d_rj(2)
!!
!!   Matrix for field and 2nd derivatives with fixed gradient
!!      dfdr =      coef_fdm_fix_dr_2ctr_2(-1,2) * dfdr(0)
!!                + coef_fdm_fix_dr_2ctr_2( 0,2) * d_rj(1)
!!                + coef_fdm_fix_dr_2ctr_2( 1,2) * d_rj(2)
!!      d2fdr2 =    coef_fdm_fix_dr_2ctr_2(-1,3) * dfdr(0)
!!                + coef_fdm_fix_dr_2ctr_2( 0,3) * d_rj(1)
!!                + coef_fdm_fix_dr_2ctr_2( 1,3) * d_rj(2)
!!@endverbatim
!!
...
!>      Matrix to evaluate radial derivative at ICB with fiexed field
      real(kind = kreal) :: coef_fdm_fix_2ctr_2(-1:1,3)
!>      Matrix to evaluate field at ICB with fiexed radial derivative
      real(kind = kreal) :: coef_fdm_fix_dr_2ctr_2(-1:1,3)
!
!
!>      Work matrix to evaluate coef_fdm_fix_2ctr_2(-1:1,3)
!!@verbatim
...
!
!>      Work matrix to evaluate coef_fdm_fix_dr_2ctr_2(-1:1,3)
!!@verbatim
...
!
      coef_fdm_fix_2ctr_2(-1,1:3) = mat_fdm_ctr_fix_2(1:3,2)
      coef_fdm_fix_2ctr_2( 0,1:3) = mat_fdm_ctr_fix_2(1:3,1)
      coef_fdm_fix_2ctr_2( 1,1:3) = mat_fdm_ctr_fix_2(1:3,3)
!
...
!
      coef_fdm_fix_dr_2ctr_2(-1,1:3) = mat_fdm_ctr_fix_dr_2(1:3,2)
      coef_fdm_fix_dr_2ctr_2( 0,1:3) = mat_fdm_ctr_fix_dr_2(1:3,1)
      coef_fdm_fix_dr_2ctr_2( 1,1:3) = mat_fdm_ctr_fix_dr_2(1:3,3)
!
...
!
!
      write(50,*) ' coef_fdm_fix_2ctr_2'
      write(50,*) ' mat_fdm21,  mat_fdm22,  mat_fdm23'
      write(50,'(1p9E25.15e3)') coef_fdm_fix_2ctr_2(-1:1,2)
      write(50,*) ' mat_fdm31,  mat_fdm32,  mat_fdm33'
      write(50,'(1p9E25.15e3)') coef_fdm_fix_2ctr_2(-1:1,3)
!
      write(50,*) ' coef_fdm_fix_dr_2ctr_2'
      write(50,*) ' mat_fdm21,  mat_fdm22,  mat_fdm23'
      write(50,'(1p9E25.15e3)') coef_fdm_fix_dr_2ctr_2(-1:1,2)
      write(50,*) ' mat_fdm31,  mat_fdm32,  mat_fdm33'
      write(50,'(1p9E25.15e3)') coef_fdm_fix_dr_2ctr_2(-1:1,3)
!
