...
!$omp parallel do
      do inod = 1, nnod_rj
        d_rj(inod,ipol%i_velo) = one
        d_rj(inod,itor%i_velo) = one
      end do
!$omp end parallel do
!
...
!$omp parallel do
      do is = 1, nnod_rj
        d_rj(is,ipol%i_magne) = 0.2
        d_rj(is,itor%i_magne) = 0.2
      end do
!$omp end parallel do
!
!
...
!$omp parallel do
      do inod = 1, nnod_rj
        d_rj(inod,ipol%i_heat_source) = 0.5
      end do
!$omp end parallel do
!
!
...
!$omp parallel do
      do inod = 1, nnod_rj
        d_rj(inod,ipol%i_light_source) = 0.1
      end do
!$omp end parallel do
!
!
