...
!
      ...
      call init_iso_ctls_labels(hd_isosurf_ctl, viz4_ctls%iso_ctls)
      call init_map_ctls_labels(hd_map_rendering, viz4_ctls%map_ctls)
      call init_pvr_ctls_labels(hd_pvr_ctl, viz4_ctls%pvr_ctls)
      call init_fline_ctl_struct(hd_fline_ctl, viz4_ctls%fline_ctls)
...
!
!
      if(viz4_ctls%i_viz_control .le. 0) return
!
...
!
     ...
     &      viz4_ctls%output_field_file_fmt_ctl)
!
      end subroutine init_viz4_ctl_label
!
!  ---------------------------------------------------------------------
!
