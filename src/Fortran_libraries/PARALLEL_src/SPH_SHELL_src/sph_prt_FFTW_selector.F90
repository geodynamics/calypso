...
!!     &          WKs_FFTW, flag_FFT)
!!      subroutine sel_verify_prt_FFTW_smp(iflag_sph_FFT, iflag_size,   &
!!     &          sph_rtp, comm_rtp, ncomp_bwd, ncomp_fwd,              &
!!     &          WKs_FFTW, flag_FFT)
...
!! ------------------------------------------------------------------
!!
!!      subroutine sel_prt_fwd_FFTW_to_send(iflag_sph_FFT, iflag_size,  &
...
!! ------------------------------------------------------------------
!!
!!      subroutine sel_prt_bwd_FFTW_from_recv(iflag_sph_FFT, iflag_size,&
...
! ------------------------------------------------------------------
!
      subroutine sel_init_prt_FFTW_smp                                  &
...
!
     ...
     &                                 WKs_FFTW%sph_comp_FFTW, flag_fft)
          ...
          call init_sph_single_FFTW(sph_rtp, WKs_FFTW%sph_sgl_FFTW,     &
     &                              flag_fft)
        end if
!
#ifdef OMP_FFTW3
...
!
      if(iflag_sph_FFT .eq. iflag_FFTW) then
        if     (iflag_size .eq. iflag_once_fft) then
          call prt_fwd_FFTW_smp_to_send                                 &
     &       (sph_rtp, comm_rtp, ncomp_fwd, n_WS, v_rtp(1,1), WS(1),    &
     &        WKs_FFTW%sph_fld_FFTW, flag_FFT)
        else if(iflag_size .eq. iflag_domain_once) then
          call prt_field_fwd_FFTW_to_send                               &
