...
\verb|[FILE_NAME]| \\
File name for diffusivity variation data {\tt [FILE\_NAME]} is defined as text. The radial variation data can be choose the same file for the reference scalar or heat source data file.

\paragraph{\tt diffusivity\_list\_ctl}
\label{href_t:diffusivity_list_ctl}
\verb|[RADIUS]  [RATIO]| \\
List of radial diffusivity variation as two real array. Feature radius {\tt [RADIUS]} and diffusivity at the point {\tt [RATIO]} is defined. The diffusivity is linearly interpolated between the radial points.
...
\verb|[RATIO]| \\
Ratio of thermal diffusivity at the point where the minimum diffusivity defined by {\tt ICB\_reduction\_radius} to the other area.
