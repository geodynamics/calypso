...
!!     &         (file_name, id_file, id_rank, sph_file)
...
!
      subroutine read_geom_rtp_file                                     &
     &         (file_name, id_file, id_rank, sph_file, ierr)
!
...
!
     ...
     &     'Read ascii grid file: ', trim(file_name)
      ...
      call read_geom_rtp_data(id_file, id_rank,                         &
...
!
     ...
     &     'Read ascii spectr modes file: ', trim(file_name)
      open (id_file,file = file_name, form = 'formatted')
      call read_spectr_modes_rj_data(id_file, id_rank,                  &
     &    sph_file%comm_IO, sph_file%sph_IO, sph_file%sph_grp_IO, ierr)
      close(id_file)
!
...
!
     ...
     &     'Read ascii grid file: ', trim(file_name)
      open (id_file,file = file_name, form = 'formatted')
      call read_geom_rtm_data(id_file, id_rank,                         &
...
!
     ...
     &     'Read ascii spectr modes file: ', trim(file_name)
      open (id_file,file = file_name, form = 'formatted')
      call read_spectr_modes_rlm_data(id_file, id_rank,                 &
     &    sph_file%comm_IO, sph_file%sph_IO, ierr)
!
      close(id_file)
!
...
!
     ...
     &     'Write ascii grid file: ', trim(file_name)
      open (id_file,file = file_name, form = 'formatted')
      call write_geom_rtp_data(id_file, id_rank,                        &
...
!
     ...
     &     'Write ascii spectr modes file: ', trim(file_name)
      open (id_file,file = file_name, form = 'formatted')
      call write_spectr_modes_rj_data(id_file, id_rank,                 &
     &    sph_file%comm_IO, sph_file%sph_IO, sph_file%sph_grp_IO)
      close(id_file)
!
...
!
     ...
     &     'Write ascii grid file: ', trim(file_name)
      open (id_file,file = file_name, form = 'formatted')
      call write_geom_rtm_data(id_file, id_rank,                        &
...
!
     ...
     &     'Write ascii spectr modes file: ', trim(file_name)
      open (id_file,file = file_name, form = 'formatted')
      call write_modes_rlm_data(id_file, id_rank,                       &
     &    sph_file%comm_IO, sph_file%sph_IO)
      close(id_file)
!
