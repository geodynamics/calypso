...
!          coef_4_composition_ctl           One       1.0  end
!        end array coef_4_composition_ctl
!        array coef_4_c_diffuse_ctl  1
!         coef_4_c_diffuse_ctl    Composite_Prandtl_number  -1.0 end
...
!
      ...
      private :: hd_n_dscalar, hd_n_dsc_diff
!
