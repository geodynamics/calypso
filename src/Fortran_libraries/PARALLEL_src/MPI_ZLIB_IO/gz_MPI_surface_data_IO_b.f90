!>@file  gz_MPI_surface_data_IO_b.f90
!!       module gz_MPI_surface_data_IO_b
!!
!!@author H. Matsui
...
!!
!!@verbatim
!!      subroutine gz_mpi_read_surf_connect_b                           &
!!     &         (IO_param, comm_IO, ele_IO, sfed_IO)
!!        type(calypso_MPI_IO_params), intent(inout) :: IO_param
!!        type(communication_table), intent(inout) :: comm_IO
!!        type(element_data), intent(inout) :: ele_IO
!!        type(surf_edge_IO_data), intent(inout) :: sfed_IO
!!      subroutine gz_mpi_write_surf_connect_b                          &
!!     &         (IO_param, comm_IO, ele_IO, sfed_IO)
!!        type(calypso_MPI_IO_params), intent(inout) :: IO_param
...
!!
!!      subroutine gz_mpi_read_surf_geometry_b                          &
!!     &         (IO_param, nod_IO, sfed_IO)
!!        type(calypso_MPI_IO_params), intent(inout) :: IO_param
!!        type(node_data), intent(inout) :: nod_IO
!!        type(surf_edge_IO_data), intent(inout) :: sfed_IO
!!      subroutine gz_mpi_write_surf_geometry_b                         &
!!     &         (IO_param, nod_IO, sfed_IO)
!!        type(calypso_MPI_IO_params), intent(inout) :: IO_param
...
!
      end subroutine gz_mpi_read_surf_connect_b
!
!------------------------------------------------------------------
!------------------------------------------------------------------
!
...
!
      end subroutine gz_mpi_write_surf_connect_b
!
!------------------------------------------------------------------
!------------------------------------------------------------------
!
...
!
      end subroutine gz_mpi_read_surf_geometry_b
!
!------------------------------------------------------------------
!------------------------------------------------------------------
!
...
!
      end subroutine gz_mpi_write_surf_geometry_b
!
!------------------------------------------------------------------
!
      end module gz_MPI_surface_data_IO_b
