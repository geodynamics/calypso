...
!!
!!@verbatim
!!      subroutine leg_f_trans_vec_sym_matmul                           &
...
!!      subroutine leg_f_trans_scl_sym_matmul                           &
...
!          st_elapsed = MPI_WTIME()
     ...
     &        nle_rtm, nlo_rtm, ncomp, comm_rtm%irev_sr, n_WR, WR,      &
...
!  even l-m
     ...
     &       (iflag_matmul, nkr(ip), n_jk_e(ip), WK_l_sml%nth_hemi_rtm, &
...
!  odd l-m
          call matmul_fwd_leg_trans                                     &
     &       (iflag_matmul, nkr(ip), n_jk_o(ip), WK_l_sml%nth_hemi_rtm, &
...
!          st_elapsed = MPI_WTIME()
          call matmul_fwd_leg_trans                                     &
     &       (iflag_matmul, nkr(ip), n_jk_e(ip), nle_rtm,               &
     &        WK_l_sml%symp(1,ip), WK_l_sml%Ps_rtm(1,jst(ip)+1),        &
     &        WK_l_sml%scl_e(1,ip))
          call matmul_fwd_leg_trans                                     &
     &       (iflag_matmul, nkr(ip), n_jk_o(ip), nle_rtm,               &
