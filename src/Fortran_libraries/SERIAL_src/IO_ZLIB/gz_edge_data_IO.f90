...
!!     &         (id_rank, comm_IO, ele_IO, sfed_IO, zbuf, ierr)
...
!!
!!      subroutine gz_read_edge_geometry(nod_IO, sfed_IO, zbuf)
!!        type(node_data), intent(inout) :: nod_IO
!!        type(surf_edge_IO_data), intent(inout) :: sfed_IO
!!        type(buffer_4_gzip), intent(inout) :: zbuf
!!      subroutine gz_write_edge_geometry(nod_IO, sfed_IO, zbuf)
...
!      write(id_file,'(a,a1)') '!', char(0)
!
      call gz_read_number_of_element(ele_IO, zbuf)
      call gz_read_element_info(ele_IO, zbuf)
!
!      write(id_file,'(a,a1)') '!', char(0)
!      write(id_file,'(a,a1)') '!  2.2  edge id for each surface',      &
!      write(id_file,'(a,a1)') '!', char(0)
!
      call gz_read_surface_4_element(sfed_IO, zbuf)
!
!      write(id_file,'(a,a1)') '!', char(0)
!      write(id_file,'(a,a1)') '!  2.3   edge id for each element',     &
!      write(id_file,'(a,a1)') '!', char(0)
!
      call gz_read_edge_4_element(sfed_IO, zbuf)
!
!
!
!      write(id_file,'(a,a1)') '!', char(0)
...
!
      ...
      call gz_write_textbuf_no_lf(zbuf)
!
      call gz_write_element_info(ele_IO, zbuf)
!
      zbuf%fixbuf(1) = hd_edge_on_surf() // char(0)
      call gz_write_textbuf_no_lf(zbuf)
!
      call gz_write_surface_4_element(sfed_IO, zbuf)
!
      zbuf%fixbuf(1) = hd_edge_on_ele() // char(0)
      call gz_write_textbuf_no_lf(zbuf)
!
      call gz_write_edge_4_element(sfed_IO, zbuf)
!
!
...
!      write(id_file,'(a,a1)') '!', char(0)
!
      call gz_read_vector_in_element(nod_IO, sfed_IO, zbuf)
!
!      write(id_file,'(a,a1)') '!', char(0)
...
!
      ...
      call gz_write_textbuf_no_lf(zbuf)
!
      call gz_write_vector_in_element(nod_IO, sfed_IO, zbuf)
!
