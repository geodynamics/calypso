...
!
     ...
     &    xx, ntot_phys, nvector_trans, i_field, i_trns, d_nod )
!
...
!
     ...
     &    xx, ntot_phys, ntensor_trans, i_field, i_trns, d_nod)
!
...
!
!$omp parallel
      call copy_vector_tmp_to_trans(nvector_trans, i_trns)
!$omp end parallel
!
...
!
!$omp parallel
      call copy_tensor_tmp_to_trans(ntensor_trans, i_trns)
!$omp end parallel
!
