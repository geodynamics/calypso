!
!      module cal_jacobian_sf_grp_lag
!
...
!
!      subroutine s_cal_jacobian_sf_grp_9(numnod, numele,               &
...
!
      ...
      integer(kind=kint) :: il1, il2, il3, il4, il5, il6, il7, il8, il9
!
!
!$omp parallel do private                                               &
!$omp&  (ist,ied,igrp,jp,inum,iele,isf,                                 &
!$omp&   i1,i2,i3,i4,i5,i6,i7,i8,i9,                                    &
!$omp&   il1,il2,il3,il4,il5,il6,il7,il8,il9,                           &
...
!
            il1 =  node_on_sf_9(1,isf)
            il2 =  node_on_sf_9(2,isf)
            il3 =  node_on_sf_9(3,isf)
            il4 =  node_on_sf_9(4,isf)
            il5 =  node_on_sf_9(5,isf)
            il6 =  node_on_sf_9(6,isf)
            il7 =  node_on_sf_9(7,isf)
            il8 =  node_on_sf_9(8,isf)
            il9 =  node_on_sf_9(9,isf)
!
            i1 =  ie(iele,il1)
            i2 =  ie(iele,il2)
            i3 =  ie(iele,il3)
...
!$omp end parallel do
!
      end subroutine s_cal_jacobian_sf_grp_9
!
!-----------------------------------------------------------------------
!
      end module cal_jacobian_sf_grp_lag
