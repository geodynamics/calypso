!>@file   sum_boundary_coriolis_rlm.f90
!!@brief  module sum_boundary_coriolis_rlm
!!
!!@author H. Matsui
...
!!     &          idx_gl_1d_rlm_j, omega_rlm, coef_cor,                 &
...
!!
!
      module sum_boundary_coriolis_rlm
!
      use m_precision
!
...
!
        d_cor_bc(j_rlm) = -coef_cor * d_cor_bc(j_rlm)
      end do
!$omp end parallel do
!
!  Degree 0
...
! ----------------------------------------------------------------------
!
      end module sum_boundary_coriolis_rlm
