...
!!
!!@verbatim
!!      subroutine calypso_send_recv_3(iflag_SR, nnod_org, nnod_new,    &
!!     &                         npe_send, isend_self,                  &
!!     &                         id_pe_send, istack_send, inod_export,  &
!!     &                         npe_recv, irecv_self,                  &
!!     &                         id_pe_recv, istack_recv, inod_import,  &
!!     &                         irev_import, X_org, X_new)
!!      subroutine calypso_send_recv_3x3(iflag_SR, nnod_org, nnod_new,  &
!!     &                         npe_send, isend_self,                  &
!!     &                         id_pe_send, istack_send, inod_export,  &
!!     &                         npe_recv, irecv_self,                  &
!!     &                         id_pe_recv, istack_recv, inod_import,  &
...
!C
!C-- RECEIVE
      call sel_cppy_from_recv_buf_3(iflag_SR, nnod_new,                 &
...
!C
!C-- RECEIVE
      call sel_cppy_from_recv_buf_3x3(iflag_SR, nnod_new,               &
     &    istack_recv(npe_recv), inod_import, irev_import,              &
