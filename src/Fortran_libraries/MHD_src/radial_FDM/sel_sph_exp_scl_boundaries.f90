...
!!     &         (sph_rj, sph_bc_S, ICB_Sspec, fdm2_center, leg,        &
...
!
     ...
     &     (sph_rj%inod_rj_center, sph_rj%idx_rj_degree_zero,           &
     &      sph_rj%nnod_rj, sph_rj%nidx_rj(2), leg%g_sph_rj,            &
     &      sph_bc_S%r_ICB, fdm2_center%dmat_fix_fld, ICB_Sspec%S_BC,   &
     &      coef_diffuse, scl_rj, dfs_rj)
...
!     &   .or. sph_bc_S%iflag_icb .eq. iflag_evolve_field) then
     ...
     &     (sph_rj%nnod_rj, sph_rj%nidx_rj(2), leg%g_sph_rj,            &
     &      sph_bc_S%kr_in, sph_bc_S%r_ICB, sph_bc_S%fdm2_fix_fld_ICB,  &
     &      ICB_Sspec%S_BC, coef_diffuse, scl_rj, dfs_rj)
      end if
!
...
!
     ...
     &     (sph_rj%nnod_rj, sph_rj%nidx_rj(2), leg%g_sph_rj,            &
     &      sph_bc_S%kr_in, sph_bc_S%r_ICB, sph_bc_S%fdm2_fix_dr_ICB,   &
     &      ICB_Sspec%S_BC, coef_diffuse,                               &
     &      k_ratio(sph_bc_S%kr_in), dk_dr(sph_bc_S%kr_in),             &
     &      scl_rj, dfs_rj)
!      else if(sph_bc_S%iflag_icb .eq. iflag_fixed_field                &
!     &   .or. sph_bc_S%iflag_icb .eq. iflag_evolve_field) then
      else
...
!     &   .or. sph_bc_S%iflag_cmb .eq. iflag_evolve_field) then
     ...
     &     (sph_rj%nnod_rj, sph_rj%nidx_rj(2), leg%g_sph_rj,            &
     &      sph_bc_S%kr_out, sph_bc_S%r_CMB, sph_bc_S%fdm2_fix_fld_CMB, &
     &      CMB_Sspec%S_BC, coef_diffuse, scl_rj, dfs_rj)
      end if
!
