!>@file   sph_FDM2_pol_viscosity_ICB.f90
!!@brief  module sph_FDM2_pol_viscosity_ICB
!!
!!@author H. Matsui
...
!!     &          fdm_e1, fdm2_fix_dr_ICB, fdm2_free_ICB,               &
...
!!@endverbatim
!!
      module sph_FDM2_pol_viscosity_ICB
!
      use m_precision
      use m_constants
!
...
!  -------------------------------------------------------------------
!
      end module sph_FDM2_pol_viscosity_ICB
