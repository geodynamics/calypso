!>@file   sph_rtp_domain_FFTW.F90
!!@brief  module sph_rtp_domain_FFTW
!!
!!@author H. Matsui
...
!
      ...
      integer(kind = kint_gl) :: ist_r, ist_c, ncomp
!
!
      flag_FFT = .TRUE.
      do nd = 1, ncomp_fwd
...
!
      end subroutine rtp_field_fwd_FFTW_to_send
!
! ------------------------------------------------------------------
!
      subroutine rtp_field_back_FFTW_from_recv(sph_rtp, comm_rtp,       &
...
!
      end subroutine rtp_field_back_FFTW_from_recv
!
! ------------------------------------------------------------------
!
      end module sph_rtp_domain_FFTW
